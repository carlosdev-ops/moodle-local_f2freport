...
class report_builder_testcase extends \advanced_testcase {
    ...
    public function test_get_field_ids() {
        ...
        $roomfieldid = $DB->insert_record('facetoface_session_field', (object)['shortname' => 'room_number', 'name' => 'Room Number']);
